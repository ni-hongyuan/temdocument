...
指定用户鼠标可以拖入的节点类型，包括自定义节点类型， 不传则不会创建节点，只会触发 callback
...
拖拽面板上显示的图标，可以传入图标 url 地址或 base64 编码
...
[去 CodeSandbox 查看示例](https://codesandbox.io/embed/elastic-mahavira-1ucwp?fontsize=14&hidenavigation=1&theme=dark&view=preview)
