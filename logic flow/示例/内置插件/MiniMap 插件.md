...
```
import { Button, Flex, Divider, Select, Form, Space } from 'antd';
import React, { useState, useEffect, useRef } from 'react';

const { Control, MiniMap } = Extension;
...
const MiniMapExtension: React.FC = () => {
...
root.render(<MiniMapExtension></MiniMapExtension>);
